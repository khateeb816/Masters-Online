...
@section('title', 'Profile - Dashtreme Admin')
    ...
    <div class="col-lg-4">
       <div class="card profile-card-2">
        <div class="card-img-block">
                <img class="img-fluid" src="{{ asset('assets/images/profile.jpg') }}" alt="Card image cap">
        </div>
        <div class="card-body pt-5">
            <img src="{{ asset('assets/images/profile.jpg') }}" alt="profile-image" class="profile">
