                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 text-center">
                                ...
                                <p class="text-muted">{{ ucfirst($category->description) }}</p>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5 class="text-primary">
                                            <i class="zmdi zmdi-account-box mr-2"></i>Category Information
                                        </h5>
                                        <table class="table table-borderless">
                                            <tr>
                                                <td><strong><i class="zmdi zmdi-account mr-2"></i>Title:</strong></td>
